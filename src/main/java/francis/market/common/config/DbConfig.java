...
public class DbConfig {
    ...
    public SessionFactory sessionFactory() throws IOException {
        ...
        sessionFactoryBean.setPackagesToScan("francis.market.project.entity", "francis.market.user.entity");
        sessionFactoryBean.setAnnotatedPackages("francis.market.project.entity", "francis.market.user.entity");
     ...
     * Reads the dbscript and initiates the Database with the name H2-Test-DB.
     *
     * @return DataSource
     */
